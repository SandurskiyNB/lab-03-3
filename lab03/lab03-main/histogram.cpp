...
void svg_frame(bool scaling, const int block_width, const int block_height, const int block_len, const int max_freak, const int offset_frame, const int section_count, const string stroke) {
	int rightX;
	if (scaling)
		rightX = 365;
	else
